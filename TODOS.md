...
- [ ] **US-domestic OCR swap-feasibility eval** — benchmark Granite-Docling 258M (clean US lineage, Apache, CPU) and Tesseract-second-pass against the Paddle baseline on api/eval/colacloud/ corpora behind the Extractor interface; produces the decision-grade accuracy delta. Effort: M → S. Priority: P2.
