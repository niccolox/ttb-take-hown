            ...
            for i, it in enumerate(items):
                ...
                con.execute(
                    ...
                    [i, it.get("file_name") or "", it.get("state") or "waiting",
                     ...
                     json.dumps(it["registry"]) if it.get("registry") else None,
                     bool(it.get("stale"))])
